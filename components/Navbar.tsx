    ...
    <header className="bg-white opacity-50 shadow-md sticky top-0 z-50">
      ...
      {menuOpen && (
        <div className="md:hidden px-6 pb-4 space-y-4">
          <Link href="/" className="block text-gray-700 hover:text-nile-blue">Home</Link>
          <Link href="#activities" className="block text-gray-700 hover:text-nile-blue">Activities</Link>
          <Link href="#aboutus" className="block text-gray-700 hover:text-nile-blue">About Us</Link>
